...
export const FilterBar = ({
    ...
    return (
        <div className="bg-slate-800/80 backdrop-blur-md p-4 rounded-xl border border-slate-700 mb-6 sticky top-4 z-20 shadow-xl">
...
const FilterSelect = ({ value, onChange, options, label }) => (
    <select
        ...
        className="bg-slate-900 border border-slate-700 rounded-lg px-3 py-2 text-sm text-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer max-w-[120px]"
    >
